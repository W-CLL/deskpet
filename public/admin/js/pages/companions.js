registerAdminPage(function createCompanionsPage({ ui, api, showToast, showLogin }) {
  ...
  function openSendDrawer() {
    ...
    globalThis.AdminFormKit.openFormDrawer({
      ...
      submitLabel: '发送来访',
      onCancel: () => form.reset(),
      focusSelector: '#companionSendSender'
    });
  }
  ...
  bindClick('createCompanionSendButton', openSendDrawer);
  return { id: 'companions', load: loadCompanions };
});
